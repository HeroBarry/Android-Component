package com.vogue.component.adapter.ui.notifications;
...
public class NotificationsFragment extends Fragment implements OnRefreshLoadMoreListener, IRecyclerViewItemClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter.addViewHolder(R.layout.try_card_item_card, new ViewHolderDelegate<Video, TryCardItemCardBinding>() {
            ...
            public void onBindingView(TryCardItemCardBinding binding, Video data, int position) {
                ...
                binding.setRecyclerViewItemClickListener(NotificationsFragment.this);
            }
        });
